...
![Watch the demo](https://dl.dropboxusercontent.com/u/449999/Lotus_demo.mov) - [Interactive demo](http://bit.ly/tbve_client-side_demo)
...
<!-- See this blog post for more on the EDL format -->
...
User can uploa a video and is returned an interactive transcrioption. Video and text are in sync. When clicking on text video jumps to corresponding part. and when video is playing text changes color.  

![giff of interactive transcript]()
...
### Release 7 - Adding paper-edit to projects + paperedit view (no preview and no outline but EDL export)
...
### Release 8 - paper-edit outline (? or if easier, done in previous release)
...
In the future there's also plans to add support for the [gentle open source STT API](http://gentle-demo.lowerquality.com) to make a out of the box  working version that does not require setup, and can work offline
...
- EDL composer
- Timecode converter
- srt parser/composer (not part of the app but developed during the inital R&D)
...
## Future plans 
- Support for live video stream to do realtime video editing 
...
## What is the impact of this software on video production?

### You save soooo much time 
...
### you can enable "non-technical" staff to work on the part they are good at
Learning how to use a video editing software as a steep learning curve. Further more they are not designed to help with the story crafting but more just to aid the cutting of video and audio as segments. with no semantic insight into the content. 
...
You can raise the level of the conversation at the level of the story crafting of the project. and really get into the nitty gritty of the "dialaogue" and/or stay at the high level of the overall structure. 

### You can get more meaningful actionable feedback
If you are working for an exec or an external client, getting feedback at that stage on the story structure,both by showing the paper-edit text and a video sequence side by side,  generally means you won’t be asked to change any of that at the end of the project. 
...
First release should be ready by the end of August. 
